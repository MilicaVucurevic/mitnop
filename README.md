...
Sirovi podaci se čuvaju u `data/raw/`, obrađeni u `data/processed/`.
...
> **Napomena:** Fajlovi se moraju pokretati redom. Svaki korak generiše međurezultate koji su ulaz za sledeći.
